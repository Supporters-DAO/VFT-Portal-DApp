...
export class Dns {
  ...
  public async allContracts(
    ...
    const payload = this._program.registry
      .createType("(String, String)", ["Dns", "AllContracts"])
      .toHex();
    ...
    const result = this._program.registry.createType(
      "(String, String, Vec<(String, ContractInfo)>)",
      reply.payload
    );
  ...
  public async getAllAddresses(
    ...
    const payload = this._program.registry
      .createType("(String, String)", ["Dns", "GetAllAddresses"])
      .toHex();
    const reply = await this._program.api.message.calculateReply({
      destination: this._program.programId,
      origin: originAddress ? decodeAddress(originAddress) : ZERO_ADDRESS,
  ...
  public async getAllNames(
    ...
    const payload = this._program.registry
      .createType("(String, String)", ["Dns", "GetAllNames"])
      .toHex();
    const reply = await this._program.api.message.calculateReply({
      destination: this._program.programId,
      origin: originAddress ? decodeAddress(originAddress) : ZERO_ADDRESS,
  ...
  public async getContractInfoByName(
    ...
    const result = this._program.registry.createType(
      "(String, String, Option<ContractInfo>)",
      reply.payload
    );
  ...
  public subscribeToNewProgramAddedEvent(
    ...
    return this._program.api.gearEvents.subscribeToGearEvent(
      ...
      ({ data: { message } }) => {
        ...
        if (
          getServiceNamePrefix(payload) === "Dns" &&
          getFnNamePrefix(payload) === "NewProgramAdded"
        ) {
          callback(
            this._program.registry
              .createType(
                '(String, String, {"name":"String","contract_info":"ContractInfo"})',
                message.payload
              )[2]
  ...
  public subscribeToProgramIdChangedEvent(
    ...
    return this._program.api.gearEvents.subscribeToGearEvent(
      ...
      ({ data: { message } }) => {
        ...
        if (
          getServiceNamePrefix(payload) === "Dns" &&
          getFnNamePrefix(payload) === "ProgramIdChanged"
        ) {
          callback(
            this._program.registry
              .createType(
  ...
  public subscribeToProgramDeletedEvent(
    ...
    return this._program.api.gearEvents.subscribeToGearEvent(
      ...
      ({ data: { message } }) => {
        ...
        if (
          getServiceNamePrefix(payload) === "Dns" &&
          getFnNamePrefix(payload) === "ProgramDeleted"
        ) {
          callback(
            this._program.registry
              .createType(
  ...
  public subscribeToAdminRemovedEvent(
    ...
    return this._program.api.gearEvents.subscribeToGearEvent(
      ...
      ({ data: { message } }) => {
        ...
        if (
          getServiceNamePrefix(payload) === "Dns" &&
          getFnNamePrefix(payload) === "AdminRemoved"
        ) {
          callback(
            this._program.registry
              .createType(
